...
import com.hexacode.cursomc.domain.Pagamento;
import com.hexacode.cursomc.domain.PagamentoComBoleto;
import com.hexacode.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws java.text.ParseException {
		...
		Categoria cat9 = new Categoria(null, "Eletrodométicos");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "dev.wagner@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,pwEncoder.encode("123"));		
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));

		Cliente cli2 = new Cliente(null, "Wagner Jesus", "jakelline.moraes@gmail.com", "38976288807", TipoCliente.PESSOAFISICA,pwEncoder.encode("123"));		
		cli2.getTelefones().addAll(Arrays.asList("27463098","93837263"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "3997", null, "Centro", "06355050", cli2, c2);
